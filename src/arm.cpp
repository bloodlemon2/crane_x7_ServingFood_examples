...
int main(int argc, char ** argv)
{
  ...
  joint_constraint.tolerance_above = angles::from_degrees(60);
  joint_constraint.tolerance_below = angles::from_degrees(60);
  ...
  q.setRPY(angles::from_degrees(0), angles::from_degrees(0), angles::from_degrees(0));
